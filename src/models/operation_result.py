...
class OperationProgress:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return { "operation_id": self.operation_id, "total_files": self.total_files,
                 "processed": self.processed_files, "successful": self.successful_files,
    ...
    def _result_to_dict(self, result: 'FileOperationResult') -> Dict[str, Any]:
        ...
        return { "source_file": result.source_file, "operation": result.operation,
                 "success": result.success, "destination_path": result.destination_path,
                 "error_message": result.error_message, "processing_time":  result.processing_time,
                 "file_size": result.file_size, "original_source_path": result.original_source_path,
